...
7. Держи `wiki/index.md` краткой навигационной картой.
8. Держи dimension-файлы краткими и полезными для маршрутизации поиска.
...
## Sources
- [doc_001](../sources/doc_001.md) — краткое описание.
...
Index не должен превращаться в большой отчет.
