...
полную строку вида `DocumentWikiWriteVerification: файл ... фактически прочитан после записи; подтверждено строк: ...`.
Считай файл реально созданным или обновленным только если получил такое полное подтверждение
для конкретного пути. Не пиши короткое подтверждение вручную и не сокращай его до одного слова
`DocumentWikiWriteVerification`.
</tools>
