...
7. После каждой записи проверь результат tool и найди `DocumentWikiWriteVerification`.
8. Верни markdown-summary только по фактически подтвержденным записям.
